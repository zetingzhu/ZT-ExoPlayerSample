...
// *       </ul>
// *   <li>All attributes that can be set on {@link PlayerControlView} and {  DefaultTimeBar} can
...
// *       of a custom extension of {@link PlayerControlView}. {@link PlayerControlView} and {
...
//public class MyPlayerView extends FrameLayout implements AdViewProvider {
//
//    /**
...
//        if (attrs != null) {
//            TypedArray a = context.getTheme().obtainStyledAttributes(attrs, androidx.media3.ui.R.styleable.PlayerView, defStyleAttr, /* defStyleRes= */ 0);
//            try {
//                shutterColorSet = a.hasValue(androidx.media3.ui.R.styleable.PlayerView_shutter_background_color);
//                shutterColor = a.getColor(androidx.media3.ui.R.styleable.PlayerView_shutter_background_color, shutterColor);
////                playerLayoutId = a.getResourceId(androidx.media3.ui.R.styleable.PlayerView_player_layout_id, playerLayoutId);
//                useArtwork = a.getBoolean(androidx.media3.ui.R.styleable.PlayerView_use_artwork, useArtwork);
//                defaultArtworkId = a.getResourceId(androidx.media3.ui.R.styleable.PlayerView_default_artwork, defaultArtworkId);
//                useController = a.getBoolean(androidx.media3.ui.R.styleable.PlayerView_use_controller, useController);
//                surfaceType = a.getInt(androidx.media3.ui.R.styleable.PlayerView_surface_type, surfaceType);
//                resizeMode = a.getInt(androidx.media3.ui.R.styleable.PlayerView_resize_mode, resizeMode);
//                controllerShowTimeoutMs = a.getInt(androidx.media3.ui.R.styleable.PlayerView_show_timeout, controllerShowTimeoutMs);
//                controllerHideOnTouch = a.getBoolean(androidx.media3.ui.R.styleable.PlayerView_hide_on_touch, controllerHideOnTouch);
//                controllerAutoShow = a.getBoolean(androidx.media3.ui.R.styleable.PlayerView_auto_show, controllerAutoShow);
//                showBuffering = a.getInteger(androidx.media3.ui.R.styleable.PlayerView_show_buffering, showBuffering);
//                keepContentOnPlayerReset = a.getBoolean(androidx.media3.ui.R.styleable.PlayerView_keep_content_on_player_reset, keepContentOnPlayerReset);
//                controllerHideDuringAds = a.getBoolean(androidx.media3.ui.R.styleable.PlayerView_hide_during_ads, controllerHideDuringAds);
//            } finally {
//                a.recycle();
//            }
//        }
...
//        PlayerControlView customController = findViewById(androidx.media3.ui.R.id.exo_controller);
//        View controllerPlaceholder = findViewById(androidx.media3.ui.R.id.exo_controller_placeholder);
...
//     */
//    public static void switchTargetView(Player player, @Nullable MyPlayerView oldPlayerView, @Nullable MyPlayerView newPlayerView) {
...
//     * {@link #switchTargetView(Player, MyPlayerView, MyPlayerView)} rather than this method. If you do
...
//        if (player == null || !player.isCommandAvailable(Player.COMMAND_GET_TRACKS) || player.getCurrentTracks().isEmpty()) {
...
//                    /* contentDescription= */ controllerHideOnTouch ? getResources().getString(androidx.media3.ui.R.string.exo_controls_hide) : null);
//        } else {
//            setContentDescription(
...
//    }
//
//    private final class ComponentListener implements Player.Listener, OnLayoutChangeListener, OnClickListener, PlayerControlView.VisibilityListener {
//
...
//            Player player = Assertions.checkNotNull(MyPlayerView.this.player);
