 ...
 */
@UnstableApi
public final class ZAspectRatioFrameLayout extends FrameLayout {
    ...
    /**
     * Resize modes for {@link ZAspectRatioFrameLayout}. One of {@link #RESIZE_MODE_FIT}, {@link
    ...
    public ZAspectRatioFrameLayout(Context context) {
        this(context, /* attrs= */ null);
    }

    public ZAspectRatioFrameLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        resizeMode = RESIZE_MODE_FIXED_WIDTH;
        if (attrs != null) {
            TypedArray a = context.getTheme().obtainStyledAttributes(attrs, androidx.media3.ui.R.styleable.AspectRatioFrameLayout, 0, 0);
            try {
                resizeMode = a.getInt(androidx.media3.ui.R.styleable.AspectRatioFrameLayout_resize_mode, RESIZE_MODE_FIT);
            } finally {
                a.recycle();
            }
        }
